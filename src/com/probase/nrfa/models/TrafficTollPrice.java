...
@Entity
@Table(name="traffic_toll_prices")  
public class TrafficTollPrice implements Serializable{  
	...
	public String getTrafficSchemeCode() {
		return trafficSchemeCode;
	}

	public void setTrafficSchemeCode(String trafficSchemeCode) {
		this.trafficSchemeCode = trafficSchemeCode;
	}
